...
#endif
 => source.AsValueEnumerable().Average();
public static ValueEnumerable<Cast<FromArray<TSource>, TSource, TResult>, TResult> Cast<TSource, TResult>(this TSource[] source, TResult typeHint) => source.AsValueEnumerable().Cast(typeHint);
...
public static ValueEnumerable<OfType<FromArray<TSource>, TSource, TResult>, TResult> OfType<TSource, TResult>(this TSource[] source, TResult typeHint) => source.AsValueEnumerable().OfType(typeHint);
