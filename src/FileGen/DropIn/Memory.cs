...
internal static partial class ZLinqDropInExtensions
{
 ...
 => source.AsValueEnumerable().Zip(second, resultSelector);
    public static ValueEnumerable<Zip<FromMemory<TFirst>, FromEnumerable<TSecond>, TFirst, TSecond>, ValueTuple<TFirst, TSecond>> Zip<TFirst, TSecond>(this Memory<TFirst> source, IEnumerable<TSecond> second) => source.AsValueEnumerable().Zip(second);
    public static ValueEnumerable<Zip<FromMemory<TFirst>, FromEnumerable<TSecond>, FromEnumerable<TThird>, TFirst, TSecond, TThird>, ValueTuple<TFirst, TSecond, TThird>> Zip<TFirst, TSecond, TThird>(this Memory<TFirst> source, IEnumerable<TSecond> second, IEnumerable<TThird> third) => source.AsValueEnumerable().Zip(second, third);
