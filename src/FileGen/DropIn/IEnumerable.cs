...
internal static partial class ZLinqDropInExtensions
{
 ...
 => (source ?? throw new ArgumentNullException("source")).AsValueEnumerable().GroupJoin(inner, outerKeySelector, innerKeySelector, resultSelector, comparer);
    ...
    public static ValueEnumerable<Index<FromEnumerable<TSource>, TSource>, ValueTuple<Int32, TSource>> Index<TSource>(this IEnumerable<TSource> source) => (source ?? throw new ArgumentNullException("source")).AsValueEnumerable().Index();
 ...
 => (source ?? throw new ArgumentNullException("source")).AsValueEnumerable().SumUnchecked();
    ...
    public static ValueTuple<TSource[], Int32> ToArrayPool<TSource>(this IEnumerable<TSource> source) => (source ?? throw new ArgumentNullException("source")).AsValueEnumerable().ToArrayPool();
 ...
 => (source ?? throw new ArgumentNullException("source")).AsValueEnumerable().Zip(second, resultSelector);
    public static ValueEnumerable<Zip<FromEnumerable<TFirst>, FromEnumerable<TSecond>, TFirst, TSecond>, ValueTuple<TFirst, TSecond>> Zip<TFirst, TSecond>(this IEnumerable<TFirst> source, IEnumerable<TSecond> second) => (source ?? throw new ArgumentNullException("source")).AsValueEnumerable().Zip(second);
