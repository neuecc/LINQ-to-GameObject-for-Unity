namespace ZLinq
{
    ...
    {
        public static ValueEnumerable<Join<TEnumerator, TEnumerator2, TOuter, TInner, TKey, TResult>, TResult> Join<TEnumerator, TEnumerator2, TOuter, TInner, TKey, TResult>(in this ValueEnumerable<TEnumerator, TOuter> source, in ValueEnumerable<TEnumerator2, TInner> inner, Func<TOuter, TKey> outerKeySelector, Func<TInner, TKey> innerKeySelector, Func<TOuter, TInner, TResult> resultSelector)
...
namespace ZLinq.Linq
{
    ...
    public
#endif
    struct Join<TEnumerator, TEnumerator2, TOuter, TInner, TKey, TResult>(in TEnumerator source, in TEnumerator2 inner, Func<TOuter, TKey> outerKeySelector, Func<TInner, TKey> innerKeySelector, Func<TOuter, TInner, TResult> resultSelector, IEqualityComparer<TKey>? comparer)
