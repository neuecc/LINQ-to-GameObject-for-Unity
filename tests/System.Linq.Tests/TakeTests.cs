...
namespace ZLinq.Tests
{
    public class TakeTests : EnumerableTests
    {
        ...
        [Theory] // [ConditionalTheory(typeof(PlatformDetection), nameof(PlatformDetection.IsLinqSpeedOptimized))]
        [InlineData(1000)]
        [InlineData(1000000)]
        ...
        public void DisposeSource(int sourceCount, int count)
        {
            ...
            using var iterator0 = source[0].Take(count).GetEnumerator();
            ...
            using var iterator1 = source[1].Take(0..end).GetEnumerator();
            ...
            using var iterator2 = source[2].Take(^startIndexFromEnd..end).GetEnumerator();
            ...
            using var iterator3 = source[3].Take(0..^endIndexFromEnd).GetEnumerator();
            ...
            using var iterator4 = source[4].Take(^startIndexFromEnd..^endIndexFromEnd).GetEnumerator();
        ...
        //    IList<int> skipTake = Xunit.Assert.IsAssignableFrom<IList<int>>(list.Skip(10).Take(20).ToArray());
