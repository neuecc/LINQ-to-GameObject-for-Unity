...
namespace ZLinq.Tests
{
    public class LeftJoinTests : EnumerableTests
    {
        ...
        public void OuterEmptyInnerNonEmpty()
        {
            ...
            Assert.Empty(outer.LeftJoin(inner, e => e.custID, e => e.custID, createJoinRec).ToArray());
        }
        ...
        public void FirstOuterMatchesLastInnerLastOuterMatchesFirstInnerSameNumberElements()
        {
            ...
            Assert.Equal(expected, outer.LeftJoin(inner, e => e.custID, e => e.custID, createJoinRec).ToArray());
        }
        ...
        public void NullComparer()
        {
            ...
            Assert.Equal(expected, outer.LeftJoin(inner, e => e.name, e => e.name, createJoinRec, null).ToArray());
        }
        ...
        public void CustomComparer()
        {
            ...
            Assert.Equal(expected, outer.LeftJoin(inner, e => e.name, e => e.name, createJoinRec, new AnagramEqualityComparer()).ToArray());
        }
        ...
        public void NullElements()
        {
            ...
            Assert.Equal(expected, outer.LeftJoin(inner, e => e, e => e, (x, y) => y, EqualityComparer<string>.Default).ToArray());
        }
        ...
        public void SelectorsReturnNull()
        {
            ...
            Assert.Equal(expected, outer.LeftJoin(inner, e => e, e => e, (x, y) => x).ToArray());
            Assert.Equal(expected, outer.LeftJoin(inner, e => e, e => e, (x, y) => y).ToArray());
        }
