...
namespace ZLinq.Tests
{
    public class AppendPrependTests : EnumerableTests
    {
        ...
        public void SameResultsRepeatCallsIntQueryAppend()
        {
            ...
            Assert.Equal(q1.Append(42).ToArray(), q1.Concat([42]));
        }
        ...
        public void SameResultsRepeatCallsIntQueryPrepend()
        {
            ...
            Assert.Equal(q1.Prepend(42).ToArray(), (new int?[] { 42 }).Concat(q1));
        }
        ...
        public void SameResultsRepeatCallsStringQueryAppend()
        {
            ...
            Assert.Equal(q1.Append("hi").ToArray(), q1.Concat(["hi"]));
        }
        ...
        public void SameResultsRepeatCallsStringQueryPrepend()
        {
            ...
            Assert.Equal(q1.Prepend("hi").ToArray(), (new string[] { "hi" }).Concat(q1));
        }

        [Fact]
        public void RepeatIteration()
        {
            var q = Enumerable.Range(3, 4).Append(12).ToArray();
            Assert.Equal(q.ToArray(), q);
            q = q.Append(14).ToArray();
            Assert.Equal(q, q);
        }
        ...
        public void PrependNoIteratingSourceBeforeFirstItem()
        {
            ...
            Assert.Equal(prepended, ie.Prepend(4).ToArray());
        }
        ...
        public void Append1ToArrayToList()
        {
            ...
            {
                var source2 = source.Append(2);
                Assert.Equal(Enumerable.Range(0, 3), source2.ToList());
                Assert.Equal(Enumerable.Range(0, 3), source2.ToArray());
            });
        }
        ...
        public void AppendNToArrayToList()
        {
            Assert.All(CreateSources(Enumerable.Range(0, 2)), source =>
            {
                var source2 = source.Append(2).Append(3);
                Assert.Equal(Enumerable.Range(0, 4), source2.ToList());
                Assert.Equal(Enumerable.Range(0, 4), source2.ToArray());
            });
        }
        ...
        public void PrependNToArrayToList()
        {
            ...
            {
                var source2 = source.Prepend(1).Prepend(0);
                Assert.Equal(Enumerable.Range(0, 4), source2.ToList());
                Assert.Equal(Enumerable.Range(0, 4), source2.ToArray());
            });
        }
        ...
        public void AppendPrependToArrayToList()
        {
            Assert.All(CreateSources(Enumerable.Range(2, 2)), source =>
            {
                var source2 = source.Prepend(1).Append(4).Prepend(0).Append(5);
                Assert.Equal(Enumerable.Range(0, 6), source2.ToList());
                Assert.Equal(Enumerable.Range(0, 6), source2.ToArray());
            });
        }
        ...
        public void AppendPrependRunOnce()
        {
            Assert.All(CreateSources(Enumerable.Range(2, 2)), source =>
            {
                Assert.Equal(Enumerable.Range(0, 6), source.RunOnce().Prepend(1).ToArray().RunOnce().Prepend(0).ToArray().RunOnce().Append(4).ToArray().RunOnce().Append(5).ToArray().RunOnce().ToList());
                Assert.Equal(Enumerable.Range(0, 6), source.Prepend(1).Prepend(0).Append(4).Append(5).ToArray().RunOnce().ToList());
            });
        }
