...
namespace ZLinq.Tests
{
    public class OfTypeTests : EnumerableTests
    {
        ...
        {
            IEnumerable<int?> e = Enumerable.Range(0, 10).Select(i => (int?)i).ToArray();
        ...
        {
            IEnumerable<object> e = Enumerable.Range(0, 10).Select(i => (object)i).ToArray();
            Assert.NotSame(e, e.OfType<int>());
            Assert.NotSame(e, e.OfType<int?>());
        ...
        public void MultipleIterations()
        {
            ...
            IEnumerable<object> objects = orig.OfType<object>().ToArray();
