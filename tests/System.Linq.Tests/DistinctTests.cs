...
namespace ZLinq.Tests
{
    public class DistinctTests : EnumerableTests
    {
        ...
        public void CustomEqualityComparer()
        {
            ...
            Xunit.Assert.Equal(expected.ToArray(), source.Distinct(new AnagramEqualityComparer()).ToArray(), new AnagramEqualityComparer());
        }
        ...
        public void CustomEqualityComparerRunOnce()
        {
            ...
            Xunit.Assert.Equal(expected.ToArray(), source.RunOnce().Distinct(new AnagramEqualityComparer()).ToArray(), new AnagramEqualityComparer());
        }
