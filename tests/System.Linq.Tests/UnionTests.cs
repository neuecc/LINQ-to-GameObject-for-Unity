...
namespace ZLinq.Tests
{
    public class UnionTests : EnumerableTests
    {
        ...
        public void CustomComparer()
        {
            ...
            Xunit.Assert.Equal(expected, first.Union(second, comparer).ToArray(), comparer);
        }
        ...
        public void RunOnce()
        {
            ...
            var comparer = new AnagramEqualityComparer();
            Xunit.Assert.Equal(expected, first.RunOnce().Union(second.RunOnce(), comparer).ToArray(), comparer);
        }
